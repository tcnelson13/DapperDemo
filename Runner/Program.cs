...
namespace Runner
{
    public class Program
    {
        ...
        static void xMain(string[] args)
        {
            ...
            //List_support_should_product_correct_results();
            //Dynamic_support_should_product_correct_results();
            //Bulk_insert_should_insert_4_rows();
            //Get_Illinois_Addresss();
        ...
        static void Get_Illinois_Addresss()
        {
            // arrange
            var repository = CreateRepositoryEx();
        ...
        static void Dynamic_support_should_product_correct_results()
        {
            // arrange
            var repository = CreateRepositoryEx();
        ...
        static void List_support_should_product_correct_results()
        {
            // arrange
            var repository = CreateRepositoryEx();
        ...
        static void Modify_should_update_existing_entity(int id)
        {
            ...
            Debug.Assert(contact.FirstName == "Bob");
            Debug.Assert(contact.Addresses[0].StreetAddress == "456 Main Street");
        }
